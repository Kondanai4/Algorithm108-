public class VariablesExample {
    public static void main(String[] args) {
        ...
        // 1.1ตัวแปรที่จะใช้เก็บค่าของขนาดของเสื้อผ้า ซึ่งมีขนาด เป็น s, m หรือ l
        char clothingSize = 's'; //'s', 'm', หรือ 'l'

        // 1.2 ตัวแปรที่ใช้เก็บค่าของจำนวนคนที่เข้ามาชมเว็บไซต์
        int websiteVisitors = 0; // จำนวนคนที่เข้ามาชมเว็บไซต์ 
        ...
        System.out.println("Websit Visitors: " + websiteVisitors);
